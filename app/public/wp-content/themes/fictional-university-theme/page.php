...
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        <?php 
            // get_pages returns pages in memory
            $hasChild = get_pages([
                "child_of" => get_the_ID() // Checks if the page has children
            ]);

            if ($the_parent or $hasChild) { ?>
            ...
            <div class="page-links">
                ...
                <ul class="min-list">
                    ...
                    wp_list_pages([
                        ...
                        "sort_column" => "menu_order" // Sorts links based on number in admin. By default links are orderd alphabet
                    ]);
                    ?>
                </ul>
            </div>
